...
public class WebController {
    ...
    private static final String FIREBASE_DATABASE_KEY = "accessToken";
    ...
    @RequestMapping("/")
    public String login() {
        return "redirect:https://suishosai.netlify.com";
    }
    ...
    public String auth(
        ...
        System.out.println("parameter scope : " + scope);
        System.out.println("parameter error : " + error);
        System.out.println("parameter errorCode : " + errorCode);
        System.out.println("parameter errorMessage : " + errorMessage);
    ...
    */
    ...
    public String success(HttpSession httpSession, Model model) {
        ...
        String hash = idToken.sub;
        String name = idToken.name;
        String pic = idToken.picture;*/
        ...
        try{
            ...
            Profile profile = StorageManager.getProfile(token.access_token);
            userId = profile.userId;
            name = URLEncoder.encode(profile.displayName, "UTF-8");
            pic = profile.pictureUrl;

            StorageManager.sendReq(userId, name, pic);

        }catch (Exception e){
            e.printStackTrace();
        }

        return "redirect:https://suishosai.netlify.com/callback?userid=" + userId;
    }
